# Public Key
Represents a Digicoin public key and is needed to be able to receive SIRX, as is usually represented as a Digicoin [Address](address.md). 

A PublicKey in digicoincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = digicoincore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new digicoincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = digicoincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
