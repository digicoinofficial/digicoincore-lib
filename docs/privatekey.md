# Private Key
Represents a Digicoin private key and is needed to be able to spend Digicoin and sign transactions.
...
Note: The WIF (Wallet Import Format) includes information about the network and if the associated public key is compressed or uncompressed (thus the same Digicoin address will be generated by using this format).
